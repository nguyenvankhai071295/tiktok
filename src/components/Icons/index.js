export const Inbox = ({ className, width = '32px', height = '32px' }) => {
    return (
        <svg
            width={width}
            height={height}
...
export const InboxAction = ({ className, width = '32px', height = '32px' }) => {
    return (
        <svg
            width={width}
            height={height}
...
export const MessageAction = ({ width = '26px', height = '26px', className }) => {
    return (
        <svg
            className={className}
            width={width}
